...
ACLOCAL = ${SHELL} '/home/cristy/WizardsToolkit-1.0.9/config/missing' aclocal-1.18
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} '/home/cristy/WizardsToolkit-1.0.9/config/missing' automake-1.18
AWK = gawk
...
PACKAGE_RELEASE_DATE = 2025-12-13
...
WIZARD_GIT_REVISION = ec5b5ec:20251213
...
.PHONY: CTAGS GTAGS TAGS all all-am all-local am--depfiles am--refresh \
	...
	install-binPROGRAMS install-binSCRIPTS install-configlibDATA \
