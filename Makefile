...
ACLOCAL = ${SHELL} '/home/cristy/WizardsToolkit-1.0.9/config/missing' aclocal-1.17
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} '/home/cristy/WizardsToolkit-1.0.9/config/missing' automake-1.17
AWK = gawk
...
CONFIGURE_ARGS = ./configure  '--disable-dependency-tracking' 'PKG_CONFIG_PATH=/usr/local//lib/pkgconfig/'
...
PACKAGE_RELEASE_DATE = 2024-11-03
...
WIZARD_GIT_REVISION = e8a4f29:20241103
