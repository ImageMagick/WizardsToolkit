...
WizardExport SHA2384Info *AcquireSHA2384Info(void)
{
  ...
  sha_info->accumulator=(WizardSizeType *) AcquireQuantumMemory(
    SHA2384Blocksize,sizeof(*sha_info->accumulator));
  ...
  (void) InitializeSHA2384(sha_info);
  return(sha_info);
}

/*
...
%                                                                             %
%                                                                             %
%   G e t S H A 3 8 4 B l o c k s i z e                                       %
%                                                                             %
%                                                                             %
%                                                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                                                                             %
%                                                                             %
%   G e t S H A 3 8 4 D i g e s t s i z e                                     %
%                                                                             %
%                                                                             %
%                                                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WizardExport WizardBooleanType InitializeSHA2384(SHA2384Info *sha_info)
{
  ...
  sha_info->accumulator[2]=WizardULLConstant(0x9159015a3070dd17);
  sha_info->accumulator[3]=WizardULLConstant(0x152fecd8f70e5939);
  sha_info->accumulator[4]=WizardULLConstant(0x67332667ffc00b31);
  sha_info->accumulator[5]=WizardULLConstant(0x8eb44a8768581511);
  sha_info->accumulator[6]=WizardULLConstant(0xdb0c2e0d64f98fa7);
  sha_info->accumulator[7]=WizardULLConstant(0x47b5481dbefa4fa4);
...
%
%      WizardBooleanType UpdateSHA2384(SHA2384Info *sha_info,
